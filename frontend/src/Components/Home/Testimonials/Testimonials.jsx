  ...
  const slideLeft = ()=>{
    ...
    return (
        <div className=" relative pb-20">
           ...
           <div className="arrow-right cursor-pointer absolute top-1/2 z-10 right-2 md:right-24 lg:right-60 p-1 text-2xl rounded-full text-white bg-[#0A453A]" onClick={slideRight}>
                    <FaAngleRight/>
                </div>
                <div className="arrow-left absolute top-1/2 z-10 left-2 md:left-32 lg:left-60 cursor-pointer  text-2xl p-1  rounded-full text-white bg-[#0A453A]" onClick={slideLeft}>
                    <FaAngleLeft/>
                </div>
