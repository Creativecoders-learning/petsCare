...
const ModalContent = ({selectedVet}) => {
      return (
            <div className="w-full px-6 pb-6">
                                    <PrimaryTitle titleStyle="text-dark font-bold text-center">Veterinarian Details</PrimaryTitle>
                                    {selectedVet && (
                                          <div className="space-y-5 text-dark-text-color">
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-5">
                                                      ...
                                                      <div className="flex flex-col sm:flex-row items-center sm:space-x-6 ">
                                                            ...
                                                            <div className="text-center sm:text-left mt-3 sm:mt-0">
                                                                  <p className="text-lg sm:text-xl font-semibold">{selectedVet?.name}</p>
                                                                  <p className="text-xs sm:text-sm">
                                                                        <span className="font-medium">Expertise:</span> {selectedVet?.expertise}
                                                                  </p>
                                                                  <p className="text-xs sm:text-sm">
                                                                        <span className="font-medium">Experience:</span> {selectedVet?.experience}
                                                                  </p>
                                                            </div>
                                                      </div>
                                                      ...
                                                      <div className="hidden lg:block">
                                                            ...
                                                            <p className="text-xs text-gray-500">{selectedVet?.instituteLocation}</p>
                                                      </div>
                                                ...
                                                <div>
                                                      ...
                                                      <p className="leading-relaxed text-gray-700">{selectedVet?.about}</p>
                                                </div>
                                          </div>
                                    )}
                              </div>
