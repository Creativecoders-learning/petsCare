                        ...
                        <div className="overflow-hidden">
                              ...
                              <div className="border-y-2 border-gray-300 py-3">
                                    <button
                                          ...
                                          onClick={() => toggleFAQ(0)}
                                    >
                                          <span className="text-2xl font-semibold text-secondary">What is included in the Basic plan?</span>
                                    ...
                                    >
                                          <p className="p-4 text-lg text-gray-700 bg-blue-50 border-l-4 border-blue-500">
                              ...
                              <div className="border-y-2 border-gray-300 py-3">
                                    <button
                                          ...
                                          onClick={() => toggleFAQ(1)}
                                    >
                                          <span className="text-2xl font-semibold text-secondary">Can I upgrade my plan later?</span>
                              ...
                              <div className="border-y-2 border-gray-300 py-3">
                                    <button
                                          ...
                                          onClick={() => toggleFAQ(2)}
                                    >
                                          <span className="text-2xl font-semibold text-secondary">Is there a money-back guarantee?</span>
                              ...
                              <div className="border-y-2 border-gray-300 py-3">
                                    <button
                                          ...
                                          onClick={() => toggleFAQ(3)}
                                    >
                                          <span className="text-2xl font-semibold text-secondary">How do I cancel my subscription?</span>
