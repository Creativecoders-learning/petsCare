...
export default function Checkout() {
      ...
      return (
            <Container>
                  <div className="flex flex-col lg:flex-row xl:flex-row justify-between items-start gap-10 my-20">
                                    ...
                                    {plan ? (
                                          <div className="text-center font-inter">
                                                ...
                                                <p className="text-gray-800 text-sm mb-6">
                                                      You have selected the <span className="font-semibold">{plan}</span> plan, designed to give you comprehensive access to exclusive features and resources.
                                                </p>
                                                ...
                                                <ul className="mt-6 text-gray-700 text-left space-y-4">
                                                      {features.map((feature, index) => (
                                                            <li key={index} className="flex items-center gap-3">
                                                                  <span className={`text-${color} font-bold text-xl`}>✔</span>
                                                                  <p>{feature}</p>
                                                            </li>
                                                      ))}
                                                </ul>
