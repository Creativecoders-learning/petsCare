            ...
            <div className="flex flex-col md:flex-row gap-6 lg:gap-0 justify-between max-w-3xl mx-auto my-10 border shadow-2xl rounded-xl font-inter bg-[#F9F9F9] overflow-hidden">
                  ...
                  <div className="w-full md:w-1/2 pt-8 relative flex flex-col items-center ">
                        ...
                        <div className="relative w-full flex justify-center items-center">
                              <img className="w-[200px] z-20" src={AUTHENTICATIONImages.registration} alt="" />
                  ...
                  <div className="w-full md:w-1/2 p-10">
                              ...
                              <div className="space-y-3">
                                    ...
                                    <div className="">
                                          <label className="flex mt-6 items-center space-x-2">
                                                ...
                                                />
                                                <span className="text-[#606060] cursor-pointer text-sm">I agree to all <span className="text-[#5D4FC4] cursor-pointer hover:underline">Terms & Conditions</span> </span>
                                          </label>
                                    </div>
                              </div>
                        ...
                        <div className="flex justify-center">
                              <p className="text-sm text-[#404040] font-light dark:text-gray-600">Already have an account?
                                    <Link to='/login' rel="noopener noreferrer" className="focus:underline hover:underline text-[#5D4FC4]"> Log in</Link>
                              </p>
                        </div>
                  </div>
            </div>
